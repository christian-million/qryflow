...
Each chunk type needs to have an associated handler. This section outlines what arguments the custom handler functions need to accept, what operations it should perform, and what results it should return. 
...
Note: This does not test that the code within your function is correct nor does it test what output each function is expected to produce.

# How the Registry Works

`qryflow` maintains and internal environment called `.qryflow_handlers` to store registered chunk handlers.
